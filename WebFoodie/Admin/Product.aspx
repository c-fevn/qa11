<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="WebFoodie.Admin.Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="pcoded-inner-content pt-0">
        ...
        <div class="align-align-seft-end">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Qunatity must be non negative" ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtQunatity"
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <div>
                                                        <asp:Image ID="imgProduct" runat="server" CssClass="ïmg-thumbnail"/>
                                                    </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        ...
                                                                        OnClientClick="return confirm('Do you want to detele this product?');" CausesValidation="false"
                                                                        >
                                                                        <i class="ti-trash"></i>
                                                                        </asp:LinkButton>
                                                                </td>
