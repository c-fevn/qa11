<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="WebFoodie.Admin.Category" %>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <div>
                                                        <asp:Image ID="imgCategory" runat="server" CssClass="ïmg-thumbnail"/>
                                                    </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        ...
                                                                        OnClientClick="return confirm('Do you want to detele this category?');">
                                                                        <i class="ti-trash"></i>
                                                                        </asp:LinkButton>
                                                                </td>
                                                            </tr>
