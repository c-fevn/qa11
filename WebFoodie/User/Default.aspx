<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebFoodie.Default" %>
<%@ Import Namespace="WebFoodie" %>
  ...
  <section class="client_section layout_padding-bottom pt-5">
    <div class="container">
      ...
      <div class="carousel-wrap row ">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1440px, 0px, 0px); transition: all 0.25s ease 0s; width: 2880px;"><div class="owl-item cloned" style="width: 480px;"><div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
          ...
          </div></div><div class="owl-item cloned" style="width: 480px;"><div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
          ...
          </div></div><div class="owl-item" style="width: 480px;"><div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
          ...
          </div></div><div class="owl-item active" style="width: 480px;"><div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
          ...
          </div></div><div class="owl-item cloned active" style="width: 480px;"><div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
