<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="WebFoodie.User.Registration" %>
            ...
            <div class="row">
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtMobile" runat="server" CssClass="form-control" placeholder="Enter Mobile Number"
                                ToolTip="Mobile Name"></asp:TextBox>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfcAddress" runat="server" ErrorMessage="Address is required" 
                ...
                <div class="row pl-4">
                    <div class="btn_box">
                        <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="btn btn-success rounded-pill pl-0 pr-4 text-white"
